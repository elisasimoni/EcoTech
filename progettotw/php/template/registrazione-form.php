<form id="registrazioneForm" action="inserireCliente.php?action=1" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-floating">
    ...
    <div class="form-floating">
      <input type="tel" name="telefono" class="rounded-0 form-control border-top-0 border-start-0 border-end-0 mb-2 shadow-none" id="telefono" placeholder="320 6392978">
    ...
    <div class="form-floating">
      <input type="email" name="email" class="rounded-0 form-control border-top-0 border-start-0 border-end-0 mb-2 shadow-none" id="email" placeholder="lorenzo.rossi@esempio.com" required>
    ...
    <div class="form-floating">
      <input type="password" name="password" class="rounded-0 form-control border-top-0 border-start-0 border-end-0 mb-2 shadow-none" id="password" placeholder="password" required>
  ...
  <input type="submit" class="w-100 btn btn-lg buttLog btn-success" name="registrati"/>
  <div class="supporto">
